...
abstract class $TodoModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      @HiveField(1) @JsonKey(name: "isCompleted") bool isCompleted});
}
...
class _$TodoModelImpl implements _TodoModel {
  _$TodoModelImpl(
      {@HiveField(0) @JsonKey(name: "title") required this.title,
      @HiveField(1) @JsonKey(name: "isCompleted") this.isCompleted = false});
  ...
  @override
  String toString() {
    return 'TodoModel(title: $title, isCompleted: $isCompleted)';
  }
...
abstract class _TodoModel implements TodoModel {
  factory _TodoModel(
          {@HiveField(0) @JsonKey(name: "title") required final String title,
          @HiveField(1) @JsonKey(name: "isCompleted") final bool isCompleted}) =
      _$TodoModelImpl;
