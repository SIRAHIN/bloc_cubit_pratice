...
abstract class $AttendanceModelCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@HiveField(0) String checkIn,
      @HiveField(1) String? checkOut,
      @HiveField(2) bool isCheckin});
}
...
class _$AttendanceModelImpl implements _AttendanceModel {
  ...
  @override
  String toString() {
    return 'AttendanceModel(checkIn: $checkIn, checkOut: $checkOut, isCheckin: $isCheckin)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, checkIn, checkOut, isCheckin);
...
abstract class _AttendanceModel implements AttendanceModel {
  const factory _AttendanceModel(
      {@HiveField(0) required final String checkIn,
      @HiveField(1) final String? checkOut,
      @HiveField(2) final bool isCheckin}) = _$AttendanceModelImpl;
